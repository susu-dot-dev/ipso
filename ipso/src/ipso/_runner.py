"""Runner-facing API for ipso.

These functions are called by the pytest runner (pytest-ipso) via
...
Usage from the runner:
    ipso._runner.load_cell(patched_source)
    ipso._runner.get_test_results()   # returns JSON string
    ipso._runner.run_teardowns()
"""
