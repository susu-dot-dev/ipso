"""Comprehensive tests for the nota_bene in-kernel API.

Coverage targets:
  - nota_bene._state      (module variables)
  - nota_bene._runner     (load_cell, get_test_results, run_teardowns)
  - nota_bene.__init__    (execute_cell, subtest, register_teardown)
"""
...
import nota_bene
import nota_bene._runner as _runner
...
class TestGetTestResults:
    ...
    def test_reflects_subtest_results(self):
        with nota_bene.subtest("case 1"):
            pass
        with nota_bene.subtest("case 2"):
    ...
    def test_passing_result_nulls(self):
        with nota_bene.subtest("passing"):
            pass
        result = json.loads(_runner.get_test_results())[0]
    ...
    def test_failing_result_has_error_and_traceback(self):
        with nota_bene.subtest("failing"):
...
class TestExecuteCell:
    ...
    def test_executes_empty_source(self):
        _runner.load_cell("")
        nota_bene.execute_cell()  # should not raise
...
class TestSubtest:
    def test_passing_subtest_appends_passing_result(self):
        with nota_bene.subtest("my case"):
            pass
        assert len(_state.test_results) == 1
    ...
    def test_failing_subtest_appends_failing_result(self):
        with nota_bene.subtest("bad case"):
    ...
    def test_failing_subtest_suppresses_exception(self):
        with nota_bene.subtest("suppressed"):
    ...
    def test_failing_subtest_does_not_stop_subsequent_subtests(self):
        executed: list[str] = []
        with nota_bene.subtest("first"):
            raise ValueError("fail")
        executed.append("after first")
        with nota_bene.subtest("second"):
            pass
    ...
    def test_traceback_contains_source_location(self):
        with nota_bene.subtest("tb check"):
    ...
    def test_error_string_matches_str_of_exception(self):
        ...
        with nota_bene.subtest("err str"):
    ...
    def test_data_driven_pattern(self):
        ...
        for case in test_cases:
            with nota_bene.subtest(f"input={case['input']}"):
    ...
    def test_subtest_name_preserved_exactly(self):
        ...
        with nota_bene.subtest(name):
            pass
        assert _state.test_results[0]["name"] == name


# ---------------------------------------------------------------------------
# nota_bene.register_teardown
# ---------------------------------------------------------------------------
...
class TestRegisterTeardown:
    def test_pushes_callback_onto_stack(self):
        ...
        nota_bene.register_teardown(fn)
    ...
    def test_multiple_registrations_in_order(self):
        ...
        nota_bene.register_teardown(fn1)
        nota_bene.register_teardown(fn2)
        nota_bene.register_teardown(fn3)
        assert _state.teardown_stack == [fn1, fn2, fn3]

    def test_registered_callbacks_run_lifo_via_runner(self):
        order: list[str] = []
        nota_bene.register_teardown(lambda: order.append("first"))
        nota_bene.register_teardown(lambda: order.append("second"))
        _runner.run_teardowns()
    ...
    def test_callback_registered_from_fixture_pattern(self):
        ...
        def fixture() -> None:
            nota_bene.register_teardown(lambda: cleaned_up.append("done"))
...
class TestFullLifecycle:
    ...
    def test_data_driven_test_pattern_with_subtests(self):
        ...
        for case in cases:
            ...
            g["_qty"] = case["qty"]
            nota_bene.execute_cell()
            with nota_bene.subtest(f"price={case['price']} qty={case['qty']}"):
    ...
    def test_teardown_fires_after_test(self):
        ...
        cleaned: list[str] = []
        nota_bene.register_teardown(lambda: cleaned.append("cleaned"))
        _runner.run_teardowns()
    ...
    def test_runner_reads_results_as_json(self):
        ...
        with nota_bene.subtest("pass"):
            pass
        with nota_bene.subtest("fail"):
