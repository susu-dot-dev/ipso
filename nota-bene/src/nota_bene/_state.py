"""Shared mutable state for the nota_bene in-kernel library.

Both the public API (nota_bene.__init__) and the runner-facing API
(nota_bene._runner) read and write this module's variables. Neither
